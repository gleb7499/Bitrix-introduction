        ...
        <div class="services-popup__links">
            ...
            <div class="services-popup__column-wrapper">
                <div class="services-popup__column" data-column="1">
                    ...
                    <a href="/services/it-infrastructure/creation/" class="services-popup__link"
                        data-category="it-infrastructure" style="display: none">Создание ИТ инфраструктуры</a>
                    <a href="/services/it-infrastructure/server-installation/" class="services-popup__link"
                        data-category="it-infrastructure" style="display: none">Установка серверного оборудования и
                        ПО</a>
                    <a href="/services/it-infrastructure/pc-support/" class="services-popup__link"
                        data-category="it-infrastructure" style="display: none">ИТ-обслуживание ПК и серверов</a>

                    <!-- Серверные решения и сети - Колонка 1 -->
                    <a href="/services/server-solutions/storage/" class="services-popup__link"
                        data-category="server-solutions" style="display: none">Внедрение хранилищ данных</a>
            ...
            <div class="services-popup__column-wrapper">
                <div class="services-popup__column" data-column="2">
                    ...
                    <a href="/services/1c/configuration/" class="services-popup__link" data-category="1c">Настройка
                        1С</a>
                    ...
                    <a href="/services/it-infrastructure/lan/" class="services-popup__link"
                        data-category="it-infrastructure" style="display: none">Монтаж локальных сетей</a>
                    <a href="/services/it-infrastructure/sks/" class="services-popup__link"
                        data-category="it-infrastructure" style="display: none">Монтаж СКС</a>
                    <a href="/services/it-infrastructure/video-surveillance/" class="services-popup__link"
