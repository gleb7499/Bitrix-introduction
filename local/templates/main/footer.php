    ...
    <section class="section section--footer-info">
        <div class="footer__columns">
            ...
            <div class="footer__column">
                ...
                <div class="footer__section">
                    ...
                    <ul class="footer__list">
                        ...
                        <li><a href="/services/1c/setup/" class="footer__link">Настройка 1С</a></li>
            ...
            <div class="footer__column">
                ...
                <ul class="footer__list">
                    <li><a href="/services/IT-infrastructure-and-equipment/creation/" class="footer__link">Создание ИТ
                            инфраструктуры</a></li>
                    <li><a href="/services/IT-infrastructure-and-equipment/server-installation/"
                            class="footer__link">Установка
                            серверного оборудования и ПО</a></li>
                    <li><a href="/services/IT-infrastructure-and-equipment/pc-support/"
                            class="footer__link">ИТ-обслуживание ПК и
                            серверов</a></li>
                    <li><a href="/services/IT-infrastructure-and-equipment/lan/" class="footer__link">Монтаж локальных
                            сетей</a></li>
                    <li><a href="/services/IT-infrastructure-and-equipment/sks/" class="footer__link">Монтаж СКС</a>
                    </li>
                    <li><a href="/services/IT-infrastructure-and-equipment/video-surveillance/"
                            class="footer__link">Установка систем
